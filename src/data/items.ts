...
export const itemMeta: Record<ItemKey, { label: string; textureKey: string; isEssential: boolean }> = {
  salt: { label: 'ملح', textureKey: 'icon_salt', isEssential: true },
  water: { label: 'موية', textureKey: 'icon_water', isEssential: true },
  charcoal: { label: 'فحم', textureKey: 'icon_charcoal', isEssential: true },
  lighter: { label: 'ولاعة', textureKey: 'icon_lighter', isEssential: true },
  hummus: { label: 'حمص', textureKey: 'icon_hummus', isEssential: false }
};
